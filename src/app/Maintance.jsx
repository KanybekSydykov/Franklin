...
import { Text, Flex, Box, Container, Img, Input } from "@chakra-ui/react";
import { usePathname, useRouter } from "next/navigation";
import { useDisclosure, Button,AlertDialog, AlertDialogBody, AlertDialogFooter, AlertDialogHeader, AlertDialogContent, AlertDialogOverlay } from '@chakra-ui/react'
...
const Maintance = ({ siteInfo, children }) => {
  ...
  if (siteInfo.technical_works && isVisible) {
    return <>{children}</>;
  } else {
    return (
      <Container
